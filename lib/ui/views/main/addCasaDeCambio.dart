...
class AddCasaDeCambio extends StatefulWidget {
  const AddCasaDeCambio({Key? key}) : super(key: key);

  @override
  State<AddCasaDeCambio> createState() => _AddCasaDeCambioState();
}

class _AddCasaDeCambioState extends State<AddCasaDeCambio> {
  String imagepath = '';
  late File imageFile;
  ...
  void handleSubmit() {
    ...
    if (error == 0) {
      ...
      print('se manda');
      HttpApi.postWithImage('/casa_de_cambio', ndata, imageFile).then((value) {
        print(value);
        ...
        print(error.data);
        GlobalTools().closeDialog();
        //show a snackbar/ algo salio mal
        final snackBar = SnackBar(
