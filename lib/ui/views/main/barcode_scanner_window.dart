...
typedef _callback = void Function(String barcode);
class BarcodeScannerWithScanWindow extends StatefulWidget {

  final _callback callback;
  const BarcodeScannerWithScanWindow({Key? key, required this.callback}) : super(key: key);
...
class _BarcodeScannerWithScanWindowState
  ...
  Future<void> onDetect(BarcodeCapture barcode) async {
    ...
    print('se escaneo el codigo ');
    String? qrcode = barcode.barcodes.first.displayValue;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: Text(translation(context).scan_qr_code_text + ' ', style: TextStyle(color: Colors.white,fontWeight: FontWeight.w100)),
        //icon to go back
        leading: IconButton(
          ...
          onPressed: () {
            ...
            NavigationService.navigateTo(Flurorouter.enviarRoute);
          },
        ),
                    ...
                    children: [
                      Center(
                        child: SizedBox(
                          ...
                          child: FittedBox(
                            child: Text(
                              barcode?.displayValue ?? translation(context).scan_qr_code_text + "!",
                              overflow: TextOverflow.fade,
                              style: Theme.of(context)
                                  .textTheme
                                  .headlineMedium!
                                  .copyWith(color: Colors.white, fontWeight: FontWeight.w100, fontSize: 18),
                            ),
                          ),
                        ),
                      ),
